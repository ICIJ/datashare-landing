...
<template>
  <div class="download-snap d-flex flex-column">
    <div class="card-body">
      <p>
        Datashare is available on the <a href="https://snapcraft.io/datashare" target="_blank">Snap Store</a>. If Snap
        is installed on your system (by default on Ubuntu and ElementaryOS), simply use the following command:
      </p>
