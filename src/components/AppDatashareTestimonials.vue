...
<template>
  <app-section class="app-datashare-testimonials p-4">
    <b-img class="app-datashare-testimonials__illustration" alt="Testimonial illustration" width="160" src="@/assets/illustrations/LandingPage_GreenPin_LightMode.svg"/>
    <div class="remove-outer-line">
      <div class="remove-double-line row row-wrap justify-content-center ">
        <datashare-testimonial v-for="(testimonial,i) in testimonials" :key="i" v-bind="testimonial" />
      </div>
    </div>
  </app-section>
</template>
