...
import TabGroupNavigationEntry
  from "@/components/TabGroup/TabGroupNavigation/TabGroupNavigationEntry.vue";
...
const variant = ref<string|undefined>('body')
...
const classList = computed(()=>{
  ...
  return classes += mode.value == "dark" ? 'bg-action-subtle text-bg-action':'bg-action text-bg-action border-0 '
})
</script>
    ...
    <b-navbar toggleable="md"  class="app-nav-bar" >
      <b-navbar-brand class="navbar-brand" href="#">
        <image-mode  class="d-inline-block align-text-bottom">
          ...
          <image-mode-source src="@/assets/illustrations/Datashare_Logo_DarkMode.svg" alt="Datashare logo" color-mode="dark"/>
        </image-mode>
      </b-navbar-brand>
      ...
      <b-collapse id="nav-collapse" is-nav>
        <tab-group-navigation class="pt-1 " >
          <tab-group-navigation-entry href="#download" ><phosphor-icon :name="osIcon"/>Download</tab-group-navigation-entry>
          ...
          <tab-group-navigation-entry href="https://icij.org/donate" rel="noreferrer noopener" target="_blank" class="text-nowrap" @mouseenter="toggleIcijLink" @mouseleave="toggleIcijLink">
            <phosphor-icon name="hand-heart" :weight="weight" :variant="variant"/>It's free! Support ICIJ</tab-group-navigation-entry>
