...
<template>
  <app-section class="app-datashare-demo ">
    ...
    <div class="app-datashare-demo__content d-flex flex-column position-relative">
      <h3 class="app-datashare-demo__content__title fw-normal col-11 px-4"> Want to dive into the <span class="fw-bold text-nowrap"> Lux Leaks</span> documents? <span class="text-nowrap gap-1 ">Try our <a href="https://datashare-demo.icij.org">demo</a><PhEyes weight="fill" class="ms-1 mb-1"/></span></h3>
      <div class="align-self-center col-10">
        <image-mode class="d-flex align-self-center py-4" image-class="rounded-4 shadow-lg" width="100%" alt="Datashare demo screenshot">
